...
class JFormFieldSelectbtn extends JFormField {
	...
	public function getInput() {
		...
		$article		= RSCommentsHelper::ArticleTitle($component, $component_id);
		
		$return  = '<a onclick="jQuery(\'#rscModal\').modal(\'show\');" class="btn btn-info btn-xsmall btnarticle">'.(!empty($article) ? $article : JText::_('COM_RSCOMMENTS_SELECT_ARTICLE')).'</a>';
