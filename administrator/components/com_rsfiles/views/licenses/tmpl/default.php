	...
	<div id="j-main-container" class="span10 j-main-container">
		...
		<table class="table table-striped adminlist">
			<thead>
				...
				<th><?php echo JHtml::_('searchtools.sort', 'COM_RSFILES_LICENSE_NAME', 'LicenseName', $listDirn, $listOrder); ?></th>
				<th width="1%" class="nowrap hidden-phone"><?php echo JHtml::_('searchtools.sort', 'JSTATUS', 'published', $listDirn, $listOrder); ?></th>
				<th width="1%" class="nowrap hidden-phone"><?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 'IdLicense', $listDirn, $listOrder); ?></th>
			</thead>
			<tbody>
