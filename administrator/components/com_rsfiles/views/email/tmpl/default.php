	...
	<div class="row-fluid">
		<div class="span12">
			<div style="width:100%;text-align:right;">
				...
				<button type="button" onclick="window.parent.jQuery('#rsf<?php echo ucfirst($this->type); ?>EmailModal').modal('hide');" class="btn button"><?php echo JText::_('COM_RSFILES_CANCEL'); ?></button>
			</div>
			<?php 
