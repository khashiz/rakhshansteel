	...
	<div class="row-fluid">
		<div class="span12">
			<div style="text-align: right;">
				...
				<button type="button" onclick="window.parent.jQuery('#rsf<?php echo ucfirst($this->type); ?>Modal').modal('hide');" class="btn button"><?php echo JText::_('COM_RSFILES_CANCEL'); ?></button>
			</div>
