...
foreach ($fieldsets as $fieldset) {
	...
	echo JHtml::_('rsfieldset.element', '<label>'.JText::_('COM_RSFILES_CONF_DOWNLOAD_FOLDER').'</label>', '<a href="javascript:void(0)" class="btn btn-info" onclick="jQuery(\'#rsfDownloadModal\').modal(\'show\');">'.JText::_('COM_RSFILES_CONF_SET_DOWNLOAD_FOLDER').'</a>');
	...
	echo JHtml::_('rsfieldset.element', '<label>'.JText::_('COM_RSFILES_CONF_BRIEFCASE_FOLDER').'</label>', '<a href="javascript:void(0)" class="btn btn-info" onclick="jQuery(\'#rsfBriefcaseModal\').modal(\'show\');">'.JText::_('COM_RSFILES_CONF_SET_BRIEFCASE_FOLDER').'</a>');
