	...
	Joomla.submitbutton = function(task) {
		if (task == 'page.cancel') {
			...
			if (document.formvalidator.isValid(document.adminForm)) {
				if (!jQuery('#jform_short_dummy').prop('readonly')) RSSeo.saveShort('<?php echo JUri::root(); ?>');
...
<form action="<?php echo JRoute::_('index.php?option=com_rsseo&view=page&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" autocomplete="off" class="form-validate form-horizontal">
	<div class="row-fluid">
		<div class="span7">
			...
			<?php if ($this->config->enable_sef && ($this->item->id != 1 && $this->item->url != 'index.php')) echo JHtml::_('rsfieldset.element', $this->form->getLabel('sef'), $this->form->getInput('sef')); ?>
			<?php if (rsseoHelper::shortEnabled()) { ?>
			<?php if ($this->item->id != 1) echo JHtml::_('rsfieldset.element', $this->form->getLabel('short'), $this->form->getInput('short')); ?>
			<?php } ?>
			...
			<div class="rsj-block">
				<div class="rsj-head">
					<h5>
						<?php echo JText::_('COM_RSSEO_PAGE_CUSTOM_HEAD_SCRIPT'); ?>
					</h5>
					<div class="rss_broken_check">
						<i class="fa fa-info-circle hasTooltip" title="<?php echo $this->escape(JText::_('COM_RSSEO_PAGE_CUSTOM_HEAD_SCRIPT_DESC')); ?>"></i>
					</div>
				</div>
				...
				<div class="rsj-content">
					<div class="rsj-box">
						...
						<div class="rsj-padding10"><?php echo JText::_('COM_RSSEO_PAGE_CUSTOM_HEAD_INFO'); ?></div>
					</div>
				</div>
			</div>
			...
			<div class="rsj-block">
				<div class="rsj-head">
					<h5>
						<?php echo JText::_('COM_RSSEO_PAGE_REMOVE_SCRIPTS'); ?>
					</h5>
					<div class="rss_broken_check">
						<i class="fa fa-info-circle hasTooltip" title="<?php echo $this->escape(JText::_('COM_RSSEO_PAGE_REMOVE_SCRIPTS_DESC')); ?>"></i>
					</div>
				</div>
				...
				<div class="rsj-content">
					<div class="rsj-box">
						...
						<div class="rsj-padding10"><?php echo JText::_('COM_RSSEO_PAGE_REMOVE_SCRIPTS_INFO'); ?></div>
					</div>
				</div>
			</div>
			...
			<div class="rsj-block">
				<div class="rsj-head">
					<h5>
						<?php echo JText::_('COM_RSSEO_PAGE_REMOVE_CSS'); ?>
					</h5>
					<div class="rss_broken_check">
						<i class="fa fa-info-circle hasTooltip" title="<?php echo $this->escape(JText::_('COM_RSSEO_PAGE_REMOVE_CSS_DESC')); ?>"></i>
					</div>
				</div>
				...
				<div class="rsj-content">
					<div class="rsj-box">
						...
						<div class="rsj-padding10"><?php echo JText::_('COM_RSSEO_PAGE_REMOVE_CSS_INFO'); ?></div>
					</div>
				</div>
			</div>
