...
<div class="row-fluid">
	...
	<div id="j-main-container" class="span10 j-main-container">
		...
		<?php if ($this->valid) { ?>
		<div id="filter-bar" class="btn-toolbar rsseo-analytics-filter">
		...
		<div class="ga_no_account">
			<h3>
				...
				<?php echo JText::_('COM_RSSEO_PLEASE_AUTH_APPLICATION'); ?> <a onclick="rsOpenWindow(this.href);return false;" href="<?php echo $this->auth; ?>" class="btn btn-success"><?php echo JText::_('COM_RSSEO_AUTHENTIFICATE'); ?></a>
			</h3>
		</div>
		<?php } ?>
	</div>
