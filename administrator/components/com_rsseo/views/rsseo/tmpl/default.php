	...
	<div class="row-fluid">
		<div class="span9">
			<div class="row-fluid">
				<div class="rsseo-stats">
					<div class="rsseo-box<?php echo isset($this->cache->size) ? ' rsseo-box-cache' : ''; ?>">
					...
					<div class="rsseo-box rsseo-box-cache">
						<div class="rsseo-box-image">
		...
		<div class="span3">
			<ul class="nav nav-tabs nav-stacked">
				...
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_rsseo&view=report'); ?>">
