...
<div id="installer-right">
	<h2>Changelog v1.21.6</h2>
	<ul class="version-history">
		<li><span class="version-new">Add</span> You can now use emoji's in the page metadata.</li>
		<li><span class="version-new">Add</span> Redirect multiple error URLs to a single redirect URL.</li>
		<li><span class="version-new">Add</span> Delete old visitors data option.</li>
		<li><span class="version-upgraded">Upg</span> Upgraded the edit page metadata from the frontend.</li>
	</ul>
