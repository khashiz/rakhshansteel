...
class JFormFieldGprofiles extends JFormFieldList
{
	...
	public function getInput() {
		if ($this->analytics->valid()) {
			...
			return '<a onclick="rsOpenWindow(this.href); return false;" href="'.$this->analytics->getAuthUrl().'" class="btn btn-success">'.JText::_('COM_RSSEO_AUTHENTIFICATE').'</a><br>'.JText::_('COM_RSSEO_CONFIGURATION_GOOGLE_ANALYTICS_PROFILES_INFO');
		}
