...
<div class="readmore uk-margin-top">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="btn uk-button uk-button-default uk-button-small uk-border-pill font uk-box-shadow-small" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo JText::_('COM_CONTENT_READ_MORE'); ?> <?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
			<?php echo '<span class="icon-chevron-' . $direction . '" aria-hidden="true"></span>'; ?> 
