...
<div id="rscomment<?php echo $this->comment->IdComment; ?>" class="media rscomment rsc_comment_big_box<?php echo $this->comment->level; ?> uk-margin-medium-bottom" <?php echo !$this->comment->published ? 'style="opacity:0.6;"' : ''; ?> itemprop="comment" itemscope itemtype="http://schema.org/UserComments" data-rsc-cid="<?php echo $this->comment->IdComment; ?>">
	...
	<div class="rscomment-body">
        ...
        <div class="uk-grid-small" data-uk-grid>
            <div class="uk-width-auto commentAvatar">
                ...
                <?php } ?>
                <span class="uk-flex uk-flex-center uk-flex-middle uk-border-circle uk-box-shadow-small font background"><?php echo mb_substr($name['cleanname'], 0, 1); ?></span>
            </div>
            <div class="uk-width-expand">
                <div class="media-body">
                    <div class="commentMeta uk-margin-small-bottom">
                        <span itemprop="creator" itemscope itemtype="http://schema.org/Person">
                            <span itemprop="name" class="name"><?php echo $name['cleanname']; ?></span>
                        </span>
                        <time class="fnum" itemprop="commentTime" datetime="<?php echo RSCommentsHelper::showDate($this->comment->date,'Y-m-d H:i:s'); ?>"><?php echo RSCommentsHelper::humanReadableDate($this->comment->date).' '.JText::_('AGO'); ?></time>
                    ...
                    <?php } ?>
                    <div class="commentConent uk-text-justify font">
                        <p id="c<?php echo $this->comment->IdComment; ?>" class="rscomm-content<?php if ($badComment) { ?> muted hidden<?php } ?>" itemprop="commentText"><?php echo RSCommentsHelper::parseComment($this->comment->comment, $this->permissions, true); ?></p>
                    </div>
