...
?>
<div class="mobToggle uk-width-1-1 uk-width-expand search<?php echo $moduleclass_sfx; ?>" hidden>
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post" class="uk-height-1-1 mobile" role="search">
		<?php
