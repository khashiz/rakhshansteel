...
foreach ($list as $item) : ?>
	<li<?php if ($id == $item->id && $view == 'category' && $option == 'com_content') echo ' class="active"'; ?>> <?php $levelup = $item->level - $startLevel - 1; ?>
		...
		<a class="uk-padding-small uk-border-rounded uk-box-shadow-small uk-h5 uk-display-block uk-link-reset uk-text-bold hovercolor font" href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($item->id)); ?>">
