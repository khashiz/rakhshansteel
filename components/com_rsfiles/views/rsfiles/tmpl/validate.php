	...
	<form method="post" action="<?php echo JRoute::_('index.php?option=com_rsfiles'.$this->itemid); ?>" name="adminForm" id="adminForm" autocomplete="off">		
		...
		<div class="well">
			...
			<div style="display: table; margin: 0 auto;">
				...
				<a href="javascript:void(0)" onclick="rsfl_refresh_captcha();" class="<?php echo rsfilesHelper::tooltipClass(); ?>" title="<?php echo rsfilesHelper::tooltipText(JText::_('COM_RSFILES_CAPTCHA_REFRESH')); ?>"><i class="fa fa-sync-alt"></i></a>
				<br />
