	...
	<fieldset class="filter">
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				<button class="btn" type="submit" title="<?php echo rsfilesHelper::tooltipText(JText::_('JSEARCH_FILTER_SUBMIT')); ?>"><i class="fa fa-search"></i></button>
				<button class="btn" type="button" onclick="document.getElementById('filter_search').value='';this.form.submit();" title="<?php echo rsfilesHelper::tooltipText(JText::_('JSEARCH_FILTER_CLEAR')); ?>"><i class="fa fa-trash"></i></button>
			</div>
