...
class rsfilesModelRsfiles extends JModelLegacy
{
	...
	public function getResults() {
		...
		$root	= rsfilesHelper::isBriefcase() ? $this->absoluteRoot : JFactory::getSession()->get('rsfilesdownloadfolder');
	...
	public function getBookmarks() {
		...
		$dbfolder	= rsfilesHelper::briefcase('CanMaintainBriefcase') ? $config->briefcase_folder : $config->briefcase_folder.$this->ds.$uid;
